...
\begin{document}
    ...
    \begin{tablist}
        ...
        \item[2024] \paperinfo{J Barry-Straume, A Sarshar, AA Popov, A Sandu}
                                ...
                                {Technical Report}
                                {arXiv}
                                {https://arxiv.org/abs/2205.03377}
        %%%%
    ...
    \begin{itemize}
        ...
        \item Artificial Intelligence, Pattern Recognition, Applied Machine Learning, Advanced Artificial Intelligence, Decision Making Under Uncertainty
    \end{itemize}
