...
\begin{document}
    ...
    \item[2023--2030]       \tab{}California State University, Long Beach \\
                              \tab{}Assistant Professor, Department of Computer Engineering and Computer Science \\

    \item[2020--2022]                \tab{} Virginia Tech\\
                            \tab{}  Postdoctoral Associate, Department of Computer Science
    ...
    %%%%
    \item[2026] \paperinfo{J Barry-Straume, AD Verulkar, A Sarshar, AA Popov, A Sandu}
                            {Ensemble based Closed-Loop Optimal Control using Physics-Informed Neural Networks}
                            {Communications in Nonlinear Science and Numerical Simulation}
                            {110063}
                            {https://doi.org/10.1016/j.cnsns.2026.110063}

    \item[2025] \paperinfo{A Raj, CE Gudumotou, S Bun, K Srinivasa, A Sarshar}
                                {Deep Operator Networks for Bayesian Parameter Estimation in PDEs}
                                {Communications on Applied Mathematics and Computation}
                                {}
                                {https://doi.org/10.1016/j.cpc.2025.109853}

    \item[2025] \paperinfo{J Barry-Straume, A Sarshar, AA Popov, A Sandu}
                            {Physics-informed neural networks for PDE-constrained optimization and control}
                            {Computer Physics Communications}
                            {317}
                            {https://doi.org/10.1007/s42967-025-00499-x}
    ...
    \item[2024] \tab{}CSULB ORED Multidisciplinary Research Grant (joint), `` A Machine Learning-Based Multi-Scale, Multi-Fidelity
    Framework for Advanced Prediction of Thermodynamic Properties in Dense Gases.''
    ...
    \begin{itemize}
        ...
        \item Artificial Intelligence, Pattern Recognition, Machine Learning, Advanced Artificial Intelligence, Decision Making Under Uncertainty
    \end{itemize}
    ...
    \begin{tablist}
    	\item[2026]  \tab{}\tab{}CSULB CECS Tenure Track Search Committee  (Chair)
        \item[2025]  \tab{}\tab{}CSULB CECS RTP Revision Committee
        \item[2024] \tab{}\tab{}CSULB CECS/STATS Data Science Degree Committee
        \item[2024, 2025] \tab{}CSULB COE  Awards Committee
        \item[2024, 2025] \tab{}CSULB CECS Graduate Curriculum Committee
        \item[2023] \tab{}\tab{}CSULB CECS Undergraduate Curriculum Committee
    ...
    \begin{tablist}
		\item[2026] \tab{} Sakol Bun, MS CS. 
		\item[2024] \tab{}Keerthana Srinivasa Naidu, MS CS. 
	 \item[2024] \tab{}Amogh Raj, MS CS. 
     \item[2023] \tab{}Carol Gudumotu, MS CS. 
    ...
    \begin{itemize}
        ...
        \item{\textit{Mathematics and Computers in Simulation}}
    ...
    %     \item[2004--07] \tab{}Acumen Inc., Mesa, Arizona
          ...
          \item[2025] \tab{} Beach Mentor Program Certificate, California State University, Long Beach.
          \item[2018] \tab{} Graduate Certificate in Future Professoriate, Virginia Tech. 
